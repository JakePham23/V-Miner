The collected eluant was concentrated by rotary evaporator to $1\mathrm{ml}$ . The extracts were finally passed through a final column filled with $5\mathrm{g}$ silica $+3\mathrm{g}$ $\mathrm{Al_2O_3}$ to remove any co-extractive compounds that may cause instrumental interferences during the analysis. The extract was eluted with $120\mathrm{ml}$ of DCM: $n$ -hexane (1:1), the first $18\mathrm{ml}$ of eluent was discarded and the rest were collected, which contains the analytes of interest. The extract was exchanged into $n$ -hexane, concentrated to $1\mathrm{ml}$ to which $1\mu \mathrm{g} / \mathrm{ml}$ of internal standard was added.
